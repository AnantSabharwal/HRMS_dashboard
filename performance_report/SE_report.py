...
class SEBaseExcelProcessor(BaseBranchExcelProcessor):
    def __init__(self):
        super().__init__()
    ...
    def process_sheets(self):
        for sheet_name in self._input_dictionary.keys():
            ...
            output_sheet['A7'] = ('Technical Ability/Knowledge (To be assessed based on the following):\n1.  Increase '
                                  'in technical skills; technical acumen progress rate\n2. Ability to solve technical '
                                  'issues with minimal guidance\n3. Ability to learn and apply\n4. Up to date '
                                  'knowlege of interconnection requirements/ regulations as related to buisness')
            output_sheet['A11'] = ('Quality/Accuracy of work/Timely Execution of Projects(To be assessed based on the '
                                   'following):\n1. Has an ongoing focus on accuracy/finds and corrects errors\n2. '
                                   'Minimal Rework for self\n3. Meeting projects due date (efficiency)')
            output_sheet['A16'] = ('Client Communication/Relationship(To be assessed based on the following)\n1. '
                                   'Relationship with Client/Client Confidence on employee\n2. Taking the extra '
                                   'step/helping client resolve issues to build relationships\n3. Clear communication '
                                   'with Client')
            output_sheet['A15'] = ('Leadership/Team Work(To be assessed based on the following):\n1. Team performance '
                                   'under your leadership ( Applies to your team as well as any cross functional team '
                                   'for which you were the team lead)\n2. Clear communication of goals/timelines with '
                                   'team members.\n3. Guiding team as needed\n4. Morale of team under your leadership')
            output_sheet['A17'] = ('*Total hrs.\n1. Consulting (Billable and Non billable):\n2. Internal rework:\n3. '
                                   'Internal Admin/ Tech Disc/Open hr/Proposals:\n4. Internal training and '
                                   'development:\n5. Internal Research:\n(*Employee please leave blank. To be '
                                   'completed by Reviewer)')
            output_sheet['A18'] = ('Overall Summary (Explain in short how have you conributed towards the growth of '
                                   'the company)')
            output_sheet['A19'] = ('Goals for Next Year( Write in short atleast three goals, including any self '
                                   'development goals for next year)')
            output_sheet['A20'] = ('*Overall Performance Rating ___________ and Feedback from Reviewer (Write in short '
            ...
            output_sheet['B8'] = 'Type of projects( Please list all types of projects worked on in the comments column)'
            ...
            output_sheet['C8'] = input_dict['Type of projects( Please list all types of projects worked on in the comments column)']
            ...
            output_sheet['B12'] = 'Maintained timeline defined by PE/ Client'
            ...
            output_sheet['C12'] = input_dict['Maintained timeline defined by PE/ Client']
            ...
            output_sheet['B15'] = 'Hours of Training imparted'
            output_sheet['C15'] = input_dict['Hours of Training imparted']
            output_sheet['D15'] = input_dict['Self3']
            output_sheet['E15'] = input_dict['Reviewer3']
            output_sheet['G15'] = input_dict['Comments (Provide Examples for each category)3']
            # leadership done
            output_sheet['B16'] = '# of Clients that directly reach out to you with new project request(Please provide name of client in comments column)'
            output_sheet['C16'] = input_dict['# of Clients that directly reach out to you with new project request(Please provide name of client in comments column)']
            output_sheet['D16'] = input_dict['Self4']
            output_sheet['E16'] = input_dict['Reviewer4']
            output_sheet['G16'] = input_dict['Comments (Provide Examples for each category)4']
            # Client communication done
            # leaving space for total hrs
            output_sheet['B18'] = input_dict['Explain in short how have you conributed towards the growth of the company']
            output_sheet['B19'] = input_dict['Write in short atleast three goals, including any self development goals for next year']
            output_sheet['B20'] = input_dict['Write in short performance feedback to the employee)\xa0(*Employee please leave blank. To be completed by Reviewer']
